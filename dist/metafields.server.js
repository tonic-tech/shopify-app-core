 ...
 */
export async function syncPlanMetafield(admin, namespace, plan) {
 ...
 */
export async function clearPlanMetafield(admin, namespace) {
 ...
 */
export async function createMetafieldDefinitions(admin, namespace, appName) {
    const definitions = [
        {
            name: "Plan",
            namespace,
...
//# sourceMappingURL=metafields.server.js.map